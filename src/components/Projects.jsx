     ...
     <div id="projects" className="max-w-5/6 m-auto pb-12 pt-8 sm:pb-16 lg:pb-20 px-4 sm:px-6">
        ...
        <div className="about_container w-full grid sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-12 lg:gap-16 xl:gap-20">
             ...
             <ProjectCard title="Minishell" link="Repo" url={minishell} flag1="#C" flag2="#Linux" flag3="#Bash"
               readmeUrl="https://github.com/MNASFA/minisheell/blob/main/README.md"
               demoUrl="https://github.com/MNASFA/minisheell/tree/main"
             ...
             <ProjectCard title="Hostel Management System" link="Repo" url={hostel} flag1="C#" flag2="#SQL Server" flag3="#CRUD" 
               readmeUrl=""
               demoUrl="https://github.com/MNASFA/hostel-project"
